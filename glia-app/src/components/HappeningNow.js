...
// EventDisplayCard is updated to not receive itinerary props
// Removed itinerary, toggleItinerary from props. Removed isSaved calculation and use.
const EventDisplayCard = ({ event }) => { 
    ...
    return (
        <div className="live-display-card">
            ...
            {/* ❌ REMOVED: The entire live-display-action div for itinerary button */}
        </div>
    );
};

// HappeningNow is updated to not receive itinerary props
const HappeningNow = () => {
            ...
            {loading ? (
                ...
                <div className="live-display-container">
                    <div className="live-display-column">
                        <h3>HALL 1</h3>
                        {/* EventDisplayCard is called without itinerary props */}
